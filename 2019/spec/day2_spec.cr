...
describe Intcode do
  ...
  it "turns 1,9,10,3,2,3,11,0,99,30,40,50 into 3500,9,10,70,2,3,11,0,99,30,40,50" do
    computer = Intcode.new("1,9,10,3,2,3,11,0,99,30,40,50")
